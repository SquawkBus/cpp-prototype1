#ifndef SQUAWKBUS_TOPICBUS_MESSAGES_MESSAGE_TYPE_HPP
#define SQUAWKBUS_TOPICBUS_MESSAGES_MESSAGE_TYPE_HPP
...
#endif // SQUAWKBUS_TOPICBUS_MESSAGES_MESSAGE_TYPE_HPP
