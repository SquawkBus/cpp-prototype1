...
namespace squawkbus::server
{
  ...
  void NotificationRepository::add_listener(
    Interactor* listener,
  ...
  void NotificationRepository::remove_listener(
    Interactor* listener,
    const std::string& topic_pattern)
  {
  ...
  void NotificationRepository::remove_interactor(Interactor* listener)
  {
    auto i_listener_topic_patterns = listener_topic_patterns_.find(listener);
    if (i_listener_topic_patterns == listener_topic_patterns_.end())
    {
  ...
  std::set<Interactor*> NotificationRepository::find_listeners(const std::string& topic) const
  {
