#ifndef SQUAWKBUS_SERVER_SUBSCRIPTION_REPOSITORY_HPP
#define SQUAWKBUS_SERVER_SUBSCRIPTION_REPOSITORY_HPP
...
#endif // SQUAWKBUS_SERVER_SUBSCRIPTION_REPOSITORY_HPP
