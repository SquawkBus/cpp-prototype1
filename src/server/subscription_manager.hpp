...
namespace squawkbus::server
{
  ...
  private:
    void add_subscription(Interactor* subscriber, const std::string& topic_pattern, const NotificationManager& notification_manager);
    void remove_subscription(Interactor* subscriber, const std::string& topic_pattern, const NotificationManager& notification_manager);
